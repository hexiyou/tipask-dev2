...
(function(){
    video.init = function(){
       ...
       // addSearchListener();
        ...
        (function(){
            ...
            if(img && img.className == "edui-faked-buy"){
    ...
    function addOkListener(){
		...
		html+='<p prize="'+$G('buyprice').value+$G('buyType').options[$G('buyType').selectedIndex].value+'" style="background-color:#E7BE6A;border:#FF6532 1px dotted;">';
            var buycontent=$G("buycontent").value;
		html+=buycontent;	
		html+='</p>';
		evals='me.execCommand("searchreplace",{"all":true,"casesensitive":false,"dir":1,"searchStr":$G("buyhidden").value,"replaceStr":\''+html+'\'});';
            editor.execCommand('insertbuy',html,evals);
        };
