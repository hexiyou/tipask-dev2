...
(function(){
    ...
    function addOkListener(){
		...
		html+='<p replyhidden="true" style="background-color:#AFC5E5; border:#FF6532 1px dotted;">';
            var buycontent=$G("replycontent").value;
		html+=buycontent;	
		html+='</p>';
		//evals='me.execCommand("searchreplace",{"all":true,"casesensitive":false,"dir":1,"searchStr":$G("replyhidden").value,"replaceStr":\''+html+'\'});';
            editor.execCommand('insertreply',html,evals);
        };
