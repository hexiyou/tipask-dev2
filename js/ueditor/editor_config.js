...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //屏幕截图配置区
        ,
        snapscreenHost: 'www.120center.com'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,
        ...
        'imagecenter', '|', 'insertimage', 'emotion', 'insertvideo', 'insertbuy','insertreply','attachment', 'map', 'gmap', 'insertframe','highlightcode','webapp','pagebreak', '|',
