...
class expertmodel {
    ...
    function get_list($showquestion=0, $start=0, $limit=3) {
        $expertlist = array();
        $query = $this->db->query("SELECT distinct u.uid,u.username,u.credit1,u.signature,u.lastlogin,u.answers,u.questions,u.expert FROM " . DB_TABLEPRE . "expert as e," . DB_TABLEPRE . "user as u WHERE u.uid=e.uid ORDER BY u.credit1 DESC LIMIT $start ,$limit");
