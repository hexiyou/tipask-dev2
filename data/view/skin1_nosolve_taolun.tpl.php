...
<div class="wrap1 ask-sub"> <span class="subleft margintop10 color06b"> <a href="<?=SITE_URL?>"><?=$setting['site_name']?></a> &gt;<a href="<?=SITE_URL?>c-all/all/4.html.html">病案讨论</a>
...
<? } } ?>
                    ...
                    <? } ?>                    <? if((0!=$question['authorid'] && ($question['authorid']==$user['uid'])) ||  1==$user['groupid']) { ?>                    <div  class="wlhdb">
                        ...
                        <span class="questioncontrol"><input type="button" class="button1"  onclick="managequest(2);return false;"  value="编辑内容"></span>
...
<? } } ?>
    ...
    <div class="huida margintop10" id="as"> <span class="hdleft" > <span class="cuowu"><span>回复内容不能少于20个汉字！</span></span> <span class="hdbt"><span><a name="我也说一句">我也说一句</a></span>(本区域内帖子可以重复提交答案，您的热心回复将给予题主非常有用的指导）</span> </span>
      <div class="clear"></div>
