...
<? } } ?>
  ...
  <? if(6==$status) { ?><a class="now">推荐问题</a><? } else { ?><a href="<?=SITE_URL?>c-<?=$cid?>/6/1.html.html">推荐问题</a><? } ?> 
      <? if(1==$status) { ?><a class="now"><font color="#ff6600">？</font>待解决</a><? } else { ?><a href="<?=SITE_URL?>c-<?=$cid?>/1/1.html.html"><font color="#ff6600">？</font>待解决</a><? } ?> 
      <? if(2==$status) { ?><a class="now"><font color="#1bbf00">√ </font>已解决</a><? } else { ?><a href="<?=SITE_URL?>c-<?=$cid?>/2/1.html.html"><font color="#1bbf00">√ </font>已解决</a><? } ?> 
      </span> 
      <!--冠名广告--> 
