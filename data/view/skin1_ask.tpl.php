...
<form name="askform" onsubmit="return check_askform(this);" action="<?=SITE_URL?>question/add.html" method="post" >
                <div class="tiwen">
                    ...
                    <div class="clr"></div>
                    <div class="shur4">
    <div style="margin-left: 75px;"><a href="#" onclick="showdetail();" title="补充更多问题细节，确保问题的准确解答！"><b id="showtype">-</b>更多问题描述(选填)</a></div>
 ...
 <div class="clr"></div>
                    ...
                    <div class="shur shur2">
                        ...
                        <div class="shezhi">
                            ...
                            <div class="clr"></div> 
                            <h3>购买置顶:</h3> 
                            <input type="checkbox" name="istop" value="0"/>&nbsp;&nbsp;&nbsp; <span>类型：</span><select name="toptype" id="scorelist" class="select1" onchange="otherscore();">
                                <option value="3" selected>分类置顶</option>
                                <option value="2">区域置顶</option>
                                <option value="1">全站置顶</option>
                            </select>&nbsp;
                            &nbsp;&nbsp;&nbsp; 
                            <span>置顶期限：</span><input type="text" name="topstart" value="" onclick="showcalendar()" style="width:90px"/>&nbsp;-<input type="text" name="topend" value="" onclick="showcalendar()" style="width:90px"/><div id="append"></div>
                            <span class="zhusi">全局置顶10天需要花费100个金币</span>
                            <br/><span class="zhusi">您的剩余金币数量:<? if($user['credit2']) { ?><?=$user['credit2']?><? } else { ?>0<? } ?> 花费一定数量金币，可以使问题获得更多曝光机会，您的问题会越受关注。</span>
