    ...
    <div class="ps_content">
        ...
        <div class="ps_contentl">
            ...
            <div class="nav_bar">
                <dl>
                    ...
                    <dd class="hover" id="myanswer"><a href="<?=SITE_URL?>?user/answer.html">我的回答</a></dd>
        ...
        <div class="ps_contentr">
            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                <tbody>
                    <tr>
                        <td class="zxy_title" align="left" valign="middle" width="400" height="38">标题（共<?=$answersize?>条）</td>
                        <td class="zxy_title" align="center" valign="middle" width="80" height="38">被采纳答案</td>
                        <td class="zxy_title" align="center" valign="middle" width="140" height="38">回答时间</td>
                    </tr>
                    <tr>
...
<? if(is_array($answerlist)) { foreach($answerlist as $answer) { ?>
                                    <tr>
                                        ...
                                        <td class="zxy_biaoge_txt f14 black" align="center" valign="middle" width="80" height="34"><? if($answer['adopttime']) { ?><font color="red">是</font><? } else { ?><font color="green">否</font><? } ?>&nbsp;</td>
