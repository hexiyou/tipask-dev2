...
<div class="wrap1 ask-sub"> <span class="subleft margintop10 color06b"> <a href="<?=SITE_URL?>"><?=$setting['site_name']?></a> &gt;<a href="<?=SITE_URL?>c-all/all/1/.html">普通咨询</a>
 
<? if(is_array($navlist)) { foreach($navlist as $nav) { ?>
  &gt; <a href="<?=SITE_URL?>c-all/1/<?=$nav['id']?>.html"><?=$nav['name']?></a>
...
<span class="questioncontrol"><input type="button" class="button1" onclick="managequest(7);return false;" value="修改问题标题" /></span>
 ...
 <span class="innerrightspan"><input type="submit" class="button4"  value="提交" /></span>
                        ...
                        <div id="edittitlediv"  style="display: none;">
                            ...
                            <form name="renameForm"  action="<?=SITE_URL?>question/edittitle.html" method="post" >
                                <input type="hidden" value="<?=$question['id']?>" name="qid"/>
                                <input type="text" name="title" value="<?=$question['title']?>" class="input2" size="30"/>
                                <span class="innerrightspan"><input type="submit" class="button4"  value="提交" /></span>
                            </form>
                        </div>
    ...
    function managequest(num){
        switch(num){
            ...
            case 6://删除问题
                ...
                break;
case 7://修改问题标题
$('#edittitlediv').css('display')=='none'?$('#edittitlediv').show():$('#edittitlediv').hide();
