...
<div class="wrap1 ask-sub"> <span class="subleft margintop10 color06b"> <a href="<?=SITE_URL?>"><?=$setting['site_name']?></a> &gt;<a href="<?=SITE_URL?>c-all/all/3.html.html">处方共享</a>
      
<? if(is_array($navlist)) { foreach($navlist as $nav) { ?>
  &gt; <a href="<?=SITE_URL?>c-<?=$nav['id']?>/all/3.html.html"><?=$nav['name']?></a>
...
<? } } ?>
                        ...
                        <? if(1==$user['groupid']) { ?>                        <div  class="wlhdb">
                            <h1>管理该回答:</h1>
                            <input type="button"  value="选为推荐答案" name="adoptanswer" onclick="adoptanswer(<?=$answer['id']?>);" class="button2" />&nbsp;
...
<? } } ?>
    ...
    <div class="huida margintop10" id="as"> <span class="hdleft" > <span class="cuowu"><span>回复内容不能少于20个汉字！</span></span> <span class="hdbt"><span><a name="我要说一句">我要说一句</a></span>（本区域帖子可以重复提交答案，积极参与处方点评对他人非常有用。）</span> </span>
      <div class="clear"></div>
...
<script src="js/imgpopup.js" type="text/javascript"></script>
