...
<script src="<?=SITE_URL?>o.js" type="text/javascript"></script><? $toolbars="'".str_replace(",", "','", $setting['editor_toolbars'])."'"; if(strpos($this->regular,"add")==false) $toolbars=str_replace("'insertbuy','insertreply',",'',$toolbars); ?><script type="text/javascript">
