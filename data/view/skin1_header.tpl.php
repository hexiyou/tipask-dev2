...
<link href="<?=SITE_URL?>skin/css/base.css?v=<? echo time(); ?>" rel="stylesheet" type="text/css" />
<link href="<?=SITE_URL?>skin/css/ask_base.css" type="text/css" rel="stylesheet" />
<link href="<?=SITE_URL?>skin/css/tiezi.css" type="text/css" rel="stylesheet" /><? if(!isset($question)) { ?><link href="<?=SITE_URL?>skin/css/list.css" type="text/css" rel="stylesheet" /><? } $toolbars="'".str_replace(",", "','", $setting['editor_toolbars'])."'"; if(strpos($this->regular,"add")==false) $toolbars=str_replace("'insertbuy','insertreply',",'',$toolbars); ?><script type="text/javascript">
var g_site_url='<?=SITE_URL?>',g_prefix='<?=$setting['seo_prefix']?>',g_suffix='<?=$setting['seo_suffix']?>';
var editor_items='<?=$setting['editor_items']?>';
var editor_options={toolbars:[[<?=$toolbars?>]],wordCount:<?=$setting['editor_wordcount']?>,elementPathEnabled:<?=$setting['editor_elementpath']?>};
var messcode='<?=$setting['code_message']?>';
</script>
