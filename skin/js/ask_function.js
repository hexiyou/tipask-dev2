...
e.style.background="url(/xxx/images/jianke_btnimg.gif) no-repeat 0 -60px";
}    
function imageOut(e) {  
e.style.background="url(/xxx/images/jianke_btnimg.gif) no-repeat";
}  
function imageClick(e) {
e.style.background="url(/xxx/images/jianke_btnimg.gif) no-repeat 0 -118px";
}      
